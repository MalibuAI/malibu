...
Same payload on `https://malibu.tech/v1/rate-card`. Full formula: [Metering & billing](/network/metering-and-billing). Canonical regimes: [Economics](/guides/economics).
