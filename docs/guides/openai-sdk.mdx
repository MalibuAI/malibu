...
Get an API key: [api.malibu.tech/auth/github/start](https://api.malibu.tech/auth/github/start). To have a coding agent do the wiring: [Agent-readable onboarding](/getting-started/agent-onboarding) (`https://get.malibu.tech/skill.md`).
