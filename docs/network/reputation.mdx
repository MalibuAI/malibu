...
* **Pool dashboard.** [console.malibu.tech](https://console.malibu.tech) shows the live pool: which Macs are online, what models they hold warm, per-provider request rate.
