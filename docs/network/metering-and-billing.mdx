...
| Endpoint                                | Purpose                                                          |
| --------------------------------------- | ---------------------------------------------------------------- |
| `GET /v1/rate-card`                     | Live per-model rate card, priced against the OpenRouter frontier |
| `GET /v1/usage`                         | Buyer's usage aggregated by day / model                          |
| `GET /providers/{provider_id}/earnings` | Provider balance, current window, last payout ready              |

Provider guide: [Payments & payouts](/guides/payments).
