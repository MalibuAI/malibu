...
description: How requests turn into credits and how credits turn into USDC on Base.
icon: coins
---
...
| Endpoint | Purpose |
| --- | --- |
| `GET https://malibu.tech/v1/rate-card` | Live per-model rate card (coordinator origin; gateway 404 is expected) |
