...
- Download pin follows GitHub Latest (accepted Malibu app **v1.8.111** as of 29 Aug 2026); public button uses `download.malibu.tech/Malibu-<tag>.dmg`, never `latest.dmg`
